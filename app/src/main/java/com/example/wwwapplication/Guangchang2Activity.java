...
public class Guangchang2Activity extends AppCompatActivity {
    ImageButton imageButton1, imageButton2, imageButton3;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_guangchang2);
...
//
                ...
                Toast.makeText(Guangchang2Activity.this, "点赞成功", Toast.LENGTH_LONG).show();
