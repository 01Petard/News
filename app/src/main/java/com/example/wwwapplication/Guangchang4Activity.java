...
public class Guangchang4Activity extends AppCompatActivity {
    ImageButton imageButton1, imageButton2;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_guangchang4);
...
//
                ...
                Toast.makeText(Guangchang4Activity.this, "点赞成功", Toast.LENGTH_LONG).show();
