...
public class Xinwen2Activity extends AppCompatActivity {
    ListView lvpinglun;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnReview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //先检查是否为空
                if(CheckInput()) {
                    PinglunDbHelper2 dbHelper = new PinglunDbHelper2(getApplicationContext(),PinglunDbHelper2.DB_NAME,null,1);
...
//                    comment.setName("评论者"+(data.size()+1)+"：");
        ...
        final PinglunDbHelper2 dbHelper = new PinglunDbHelper2(getApplicationContext(),PinglunDbHelper2.DB_NAME,null,1);
