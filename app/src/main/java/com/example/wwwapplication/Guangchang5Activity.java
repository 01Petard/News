...
public class Guangchang5Activity extends AppCompatActivity {
    ImageButton imageButton1, imageButton2, imageButton3;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_guangchan5);
...
//
                ...
                Toast.makeText(Guangchang5Activity.this, "点赞成功", Toast.LENGTH_LONG).show();
